...
local terrainFragmentShader =
    love.filesystem.read('src/terrain.frag')
...
function love.load()
    ...
    seamlessPlasmaColor = love.graphics.newImage("assets/seamlessPlasmaColor.png")
    seamlessPlasmaColor:setWrap("repeat", "repeat")


    t1 = love.graphics.newImage("assets/water.png")
    t1:setWrap("repeat", "repeat")

    t2 = love.graphics.newImage("assets/burnt_sand_light.png")
    t2:setWrap("repeat", "repeat")

    t3 = love.graphics.newImage("assets/burnt_sand_lighter.png")
